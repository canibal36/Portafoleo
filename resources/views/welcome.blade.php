...
<head>
    ...
    <!-- Site Title -->
    <title>Potafoleo personal </title>
            ...
            <div class="row">
                <div class="col-12 d-flex flex-wrap align-items-center">
                    ...
                    <div class="header-info-list d-none d-md-inline-block">
                        <ul class="ul-reset">
                            <li><a href="mailto:mail@gerolddesign.com">leo11pitb@gmail.com</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="header-menu">
                        <nav>
                            <ul>
                                ...
                                <li><a href="#works-section">Realizados</a></li>
                                <li><a href="#resume-section">Resumen</a></li>
                    ...
                    <div class="header-button">
                        <a href="#" class="btn tj-btn-primary">¡Contactame!</a>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="hero-content-box">
                            <span class="hero-sub-title wow fadeInLeft" data-wow-delay="1.1s">Soy Leonel Arízaga</span>
                            <h1 class="hero-title wow fadeInLeft" data-wow-delay="1.2s">Web Developer +<br>UX Designer
                            </h1>
                            ...
                            <p class="lead wow fadeInLeft" data-wow-delay="1.4s">¡Hola! Soy un informático en sistemas especializado en desarrollo web, te ofresco la creación de sitios web que te brindaran soluciones é innovaciones para tu emprendimiento, negocio o empresa de diversos sectores.

tambien te ofresco el servicio de creacion de aplicaciones móviles para IOS y Android, estoy comprometido a ofrecer soluciones tecnológicas a medida que se adapten a las necesidades específicas de mis clientes. Mi enfoque se centra en la excelencia técnica, combinada con una comprensión detallada de las necesidades del usuario y los requisitos comerciales.

Estare con tigo desde la creación hasta la implementación y el mantenimiento continuo de tu sistema, estoy aquí para ayudarte a alcanzar tus objetivos digitales. Ya sea que estés buscando lanzar una nueva presencia en línea, optimizar un sistema existente o desarrollar una aplicación móvil para tu negocio o empresa, estoy preparado para hacer realidad tus ideas y llevar tu proyecto al siguiente nivel. </p>
                            <div class="button-box d-flex flex-wrap align-items-center">
                                <a href="#" class="btn tj-btn-secondary wow fadeInLeft" data-wow-delay="1.5s">Subir </a>
                    ...
                    <div class="row">
                        <div class="col-6 col-lg-3">
                            <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                ...
                                <div class="text">Webs <br>acivas</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                <div class="number"><span class="odometer" data-count="50">0</span>+</div>
                                <div class="text">Visitas a este<br>Sitio web</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                <div class="number"><span class="odometer" data-count="10">0</span></div>
                                <div class="text">Clientes <br>Satisfechos</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                <div class="number"><span class="odometer" data-count="24">0</span></div>
                                <div class="text">Meses de <br>Experiencia </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-header text-center">
                            <h2 class="section-title wow fadeInUp" data-wow-delay=".3s">Mis Servicios</h2>
                            <p class=" wow fadeInUp" data-wow-delay=".4s">Aqui tienes una guia de los todo los trabajos que yo realizo.</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="portfolio-section" id="works-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-header text-center">
                            <h2 class="section-title wow fadeInUp" data-wow-delay=".3s">Mis Herramientas </h2>
                            <p class=" wow fadeInUp" data-wow-delay=".4s">Aqui te muestro todo mi equipo de trabajo</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="portfolio-filter text-center wow fadeInUp" data-wow-delay=".5s">
                            <div class="button-group filter-button-group">
                                <button data-filter="*" class="active">Todo</button>
                                <button data-filter=".uxui">Laptops</button>
                                <button data-filter=".branding">Pantallas</button>
                                <button data-filter=".mobile-app">Camara</button>
                        ...
                        <div class="portfolio-box wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="portfolio-item branding">
                                ...
                                <div class="content-box">
                                    <h3 class="portfolio-title">MackBook Pro 2022</h3>
                                    <p>SSD de 1 TB - RAM de 16 - Procesador similar a un i7.</p>
                                    <i class="flaticon-up-right-arrow"></i>
                            ...
                            <div class="portfolio-item uxui">
                                ...
                                <div class="content-box">
                                    <h3 class="portfolio-title">Hp Victus</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="section-header wow fadeInUp" data-wow-delay=".3s">
                            <h2 class="section-title">Mis Niveles</h2>
                        </div>
        ...
        <section class="skills-section" id="skills-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-header text-center">
                            <h2 class="section-title wow fadeInUp" data-wow-delay=".3s">Mis Lenguajes de Programación </h2>
